...
class ProcessManager( object ):
    ...
    def __init__(self, dataframe=None, run_id=None, run_name=None, context_version=" ", data_stream=" ", source=" ", new_process="False"):
    ...
    def process_new(self):
        print("Bringing new process up to date, current run num: ", self.run_id)
    ...
    def process(self):
        ...
        if(self.df.empty):
            print("*********************EMPTY DATAFRAME PASSED TO PROCESS*******************************")
            return
        if(self.new_process == 'True'):
            print("NEW PROCESS PASSED TO PROCESS MANAGER!!!!")
        if self.data_stream == 'calibration':
